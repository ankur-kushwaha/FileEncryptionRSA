 ...
 */
public class RSAEncryptionDescryption {
	...
	public void createKeys() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
		System.out
				.println("-------GENRATE PUBLIC and PRIVATE KEY-------------");
		...
		saveKeys(PUBLIC_KEY_FILE, rsaPubKeySpec.getModulus(),
				rsaPubKeySpec.getPublicExponent());
		saveKeys(PRIVATE_KEY_FILE, rsaPrivKeySpec.getModulus(),
				rsaPrivKeySpec.getPrivateExponent());
	...
	public String decryptData(byte[] data) throws IOException {
		...
		try {
			...
			decryptedString = new String(descryptedData);
